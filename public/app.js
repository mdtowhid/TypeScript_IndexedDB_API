...
let { title, body, category, submitBtn, modal, footer, searchBoxInput, found, notFound, preferences, preferenceIcon, } = Dom;
...
::
*/
window.addEventListener("load", (e) => __awaiter(void 0, void 0, void 0, function* () {
    /*
  ::
...
searchBoxInput.addEventListener("keyup", (e) => {
    ...
    if (queryString.length > 3) {
        const blogs = Search.searchBlog(queryString.toLowerCase());
        if (blogs.length > 0) {
            found.innerHTML = `
        <hr>
